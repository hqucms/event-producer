...
cmsDriver.py Configuration/GenProduction/python/${NAME}.py \
  --python_filename "RunIISummer20UL16APVwmLHE_${NAME}_cfg.py" \
  --eventcontent RAWSIM,LHE \
  --customise Configuration/DataProcessing/Utils.addMonitoring \
  --datatier GEN,LHE \
  --fileout "file:RunIISummer20UL16APVwmLHE_$NAME_$JOBINDEX.root" \
...
cmsDriver.py \
  --python_filename "RunIISummer20UL16APVSIM_${NAME}_cfg.py" \
  --eventcontent RAWSIM \
  --customise Configuration/DataProcessing/Utils.addMonitoring \
  --datatier GEN-SIM \
  --fileout "file:RunIISummer20UL16APVSIM_$NAME_$JOBINDEX.root" \
  --conditions 106X_mcRun2_asymptotic_preVFP_v8 \
  --beamspot Realistic25ns13TeV2016Collision \
  --step SIM \
  --geometry DB:Extended \
  --filein "file:RunIISummer20UL16APVwmLHE_$NAME_$JOBINDEX.root" \
  --era Run2_2016_HIPM \
  --runUnscheduled \
  --mc \
  --nThreads $NTHREAD \
...
cmsDriver.py \
  --python_filename "RunIISummer20UL16APVDIGIPremix_${NAME}_cfg.py" \
  --eventcontent PREMIXRAW \
  --customise Configuration/DataProcessing/Utils.addMonitoring \
  --datatier GEN-SIM-DIGI \
  --filein "file:RunIISummer20UL16APVSIM_$NAME_$JOBINDEX.root" \
  --fileout "file:RunIISummer20UL16APVDIGIPremix_$NAME_$JOBINDEX.root" \
...
source /cvmfs/cms.cern.ch/cmsset_default.sh
export RELEASE=CMSSW_8_0_36_UL_patch2
if [ -r $RELEASE/src ]; then
  echo release $RELEASE already exists
else
  scram p CMSSW $RELEASE
...
cmsDriver.py \
  --python_filename "RunIISummer20UL16APVHLT_${NAME}_cfg.py" \
  --eventcontent RAWSIM \
  --inputCommands "keep *","drop *_*_BMTF_*","drop *PixelFEDChannel*_*_*_*" \
  --outputCommand "keep *_mix_*_*,keep *_genPUProtons_*_*" \
  --customise Configuration/DataProcessing/Utils.addMonitoring \
  --datatier GEN-SIM-RAW \
  --filein "file:RunIISummer20UL16APVDIGIPremix_$NAME_$JOBINDEX.root" \
  --fileout "file:RunIISummer20UL16APVHLT_$NAME_$JOBINDEX.root" \
...
cmsDriver.py \
  --python_filename "RunIISummer20UL16APVRECO_${NAME}_cfg.py" \
  --eventcontent AODSIM \
  --customise Configuration/DataProcessing/Utils.addMonitoring \
  --datatier AODSIM \
  --filein "file:RunIISummer20UL16APVHLT_$NAME_$JOBINDEX.root" \
  --fileout "file:RunIISummer20UL16APVRECO_$NAME_$JOBINDEX.root" \
  --conditions 106X_mcRun2_asymptotic_preVFP_v8 \
...
cmsDriver.py \
  --python_filename "RunIISummer20UL16APVMINIAODSIM_${NAME}_cfg.py" \
  --eventcontent MINIAODSIM \
  --customise Configuration/DataProcessing/Utils.addMonitoring \
  --datatier MINIAODSIM \
  --filein "file:RunIISummer20UL16APVRECO_$NAME_$JOBINDEX.root" \
...
cmsRun -j FrameworkJobReport.xml "RunIISummer20UL16APVMINIAODSIM_${NAME}_cfg.py"
